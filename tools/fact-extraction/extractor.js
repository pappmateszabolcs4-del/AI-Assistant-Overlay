...
function buildSystemPrompt(policy) {
  ...
  return [
    ...
    'Include a mix of high-signal gameplay intelligence and supporting systemic knowledge.',
    'High-signal: emergent consequences, tradeoffs, optimization, tactical/system implications.',
    'Supporting systemic: setup, workflow, infrastructure, maintenance, dependencies, progression links, operational constraints.',
    'At least 2 facts should be supporting systemic knowledge when available in the text.',
